...
StackMCP runs as a local daemon on your machine. Head over to the [what-is-stackmcp](docs/what-is-stackmcp.md) doc to learn about the project, or dive into the [YouTube-to-Obsidian example](examples/youtube-to-obsidian.md) to see a workflow in action.
